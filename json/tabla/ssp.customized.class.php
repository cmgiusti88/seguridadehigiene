...
class SSP
{
  ...
  static function simple($request,$sql_details,$table,$primaryKey,$columns,$joinQuery = NULL,$extraWhere = '',$groupBy = '')
  {
    ...
    {
      $query = "SELECT SQL_CALC_FOUND_ROWS `".implode("`, `", SSP::pluck($columns,'db'))."` FROM `$table` $where $extraWhere $groupBy $order $limit";
    }
  ...
  static function sql_connect($sql_details)
  {
    ...
    {
      SSP::fatal("Ocurrió un error al conectarse a la base de datos. "." El error informado por el servidor fue: ".$e->getMessage());
    }
    return $db;
  }
  static function sql_exec($db,$bindings,$sql=null)
  {
    ...
    {
      SSP::fatal("Ocurrió un error de SQL: ".$e->getMessage());
    }
    return $stmt->fetchAll();
  }
  static function fatal ( $msg )
  {
    echo json_encode(array("error" => $msg));exit(0);
  }
